  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: any, record: any) => {
        const menu = (
          <Menu>
            <Menu.Item key="edit" icon={<Edit size={16} />} onClick={() => navigate('/add-city')}>
              Edit
            </Menu.Item>
  ...
  return (
    <div className="page-container">
      <div className="page-header">
        <h1 className="page-title">Manage City</h1>
        <Button
  type="primary"
  icon={<Plus size={16} />}
...
>
  Add City
      ...
      <Modal
        ...
        closeIcon={<X />}
      >
        <p>Are you sure you want to delete <strong>{userToDelete?.city}</strong>?</p>
      </Modal>
    </div>
  );
};
